...
### Prerequisites
Make sure you have `git`, `Python 3.9+`, and `pip` installed on your system. GPU support (CUDA) is recommended for training models.
...
---
<p align="center">Made with ❤️ for Sustainable Agriculture and Smart Farming</p>
